...
const HeaderBanner = () => {
    return (
        <div className=' md:flex items-center my-2   '>
            ...
            <div className=' md:order-last  md:w-1/2 p-3 container'>
                ...
                <p className='text-xl md:inline hidden  gray-text  '>Along with 1000s of cars to choose from, you can apply for finance online and value <br /> your existing car all from the comfort of your favourite armchair.</p>
            </div>
            <div>
