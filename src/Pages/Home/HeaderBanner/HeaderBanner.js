    ...
    return (
        <div className=' md:flex items-center my-2   '>
            ...
            <div className=' md:order-last  md:w-1/2 p-2 container'>
                ...
                <p className='text-xl p-3 gray-text '>Along with 1000s of cars to choose from, you can apply for finance online and value <br /> your existing car all from the comfort of your favourite armchair</p>
            </div>
            <div>
